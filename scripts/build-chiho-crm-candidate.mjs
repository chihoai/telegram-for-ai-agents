...
export async function buildCandidate({ release, environment, output, backendManifest }) {
  if (!["v2", "v3", "v4"].includes(release)) throw new Error("Choose release v2, v3 or v4.");
